...
{  
    ...
    physConcrete = new G4PVPlacement(0, G4ThreeVector(0.,0.,-ConcreteHeight/2-1.0*mm), logicalConcrete, "physConcrete", logicalWorld, false, 0, true);
   ...
   //---- solidTarget------
    ...
    //phys_block_Target = new G4PVPlacement(0,G4ThreeVector(0.,0.,ConcreteHeight+BlockHeight/2+10),logical_block_target,"physTarget",logicalWorld,false,0,true); 
